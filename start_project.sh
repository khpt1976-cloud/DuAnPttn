...
echo "   Frontend: https://work-2-fewblihqnnirrlef.prod-runtime.all-hands.dev"
echo "   Backend API: https://work-1-fewblihqnnirrlef.prod-runtime.all-hands.dev"
echo "   API Documentation: https://work-1-fewblihqnnirrlef.prod-runtime.all-hands.dev/docs"
echo ""
